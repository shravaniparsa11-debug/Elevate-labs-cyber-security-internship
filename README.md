...
Network:scanme.nmap.org (45.33.32.156)
...
The scan was completed successfully. It identified an active host along with its open, filtered, and closed TCP ports, demonstrating the use of Nmap for basic network scanning.Objective
To scan a target device and identify active TCP ports and their associated services. 
